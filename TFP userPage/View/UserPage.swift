        ...
        NavigationView {
            VStack {
                ...
                .fullScreenCover(item: $selectedPortfolioPhotoIndex) { index in
                    PhotoSlider(selectedPhotoIndex: index.id, photos: portfolio, isFullScreen: $isFullScreen)
                }
                ...
                .fullScreenCover(item: $selectedReferencePhotoIndex) { index in
                    PhotoSlider(selectedPhotoIndex: index.id, photos: references, isFullScreen: $isFullScreen)
                }
